...
public class MixinEFAnimations {
    ...
    private static float dcfixes$greatswordTwohandAuto1Damage(float value) {
        return DawncraftFixesConfig.COMMON.getValues().<ForgeConfigSpec.ConfigValue<Double>>get("dual_greatsword.greatsword_twohand_auto.1.damage").get().floatValue();
    }
    ...
    private static float dcfixes$greatswordTwohandAuto1AttackSpeed(float value) {
        return DawncraftFixesConfig.COMMON.getValues().<ForgeConfigSpec.ConfigValue<Double>>get("dual_greatsword.greatsword_twohand_auto.1.attackSpeed").get().floatValue();
    }
    ...
    private static float dcfixes$greatswordTwohandAuto2Damage(float value) {
        return DawncraftFixesConfig.COMMON.getValues().<ForgeConfigSpec.ConfigValue<Double>>get("dual_greatsword.greatsword_twohand_auto.2.damage").get().floatValue();
    }
    ...
    private static float dcfixes$greatswordTwohandAuto3Damage(float value) {
        return DawncraftFixesConfig.COMMON.getValues().<ForgeConfigSpec.ConfigValue<Double>>get("dual_greatsword.greatsword_twohand_auto.3.damage").get().floatValue();
    }
    ...
    private static float dcfixes$greatswordDualAuto1Damage(float value) {
        return DawncraftFixesConfig.COMMON.getValues().<ForgeConfigSpec.ConfigValue<Double>>get("dual_greatsword.greatsword_dual_auto.1.damage").get().floatValue();
    }
    ...
    private static float dcfixes$greatswordDualAuto1Damage1(float value) {
        return DawncraftFixesConfig.COMMON.getValues().<ForgeConfigSpec.ConfigValue<Double>>get("dual_greatsword.greatsword_dual_auto.1.damage1").get().floatValue();
    }
    ...
    private static float dcfixes$greatswordDualAuto1AttackSpeed(float value) {
        return DawncraftFixesConfig.COMMON.getValues().<ForgeConfigSpec.ConfigValue<Double>>get("dual_greatsword.greatsword_dual_auto.1.attackSpeed").get().floatValue();
    }
    ...
    private static float dcfixes$greatswordDualAuto2Damage(float value) {
        return DawncraftFixesConfig.COMMON.getValues().<ForgeConfigSpec.ConfigValue<Double>>get("dual_greatsword.greatsword_dual_auto.2.damage").get().floatValue();
    }
    ...
    private static float dcfixes$greatswordDualAuto2AttackSpeed(float value) {
        return DawncraftFixesConfig.COMMON.getValues().<ForgeConfigSpec.ConfigValue<Double>>get("dual_greatsword.greatsword_dual_auto.2.attackSpeed").get().floatValue();
    }
    ...
    private static float dcfixes$greatswordDualAuto3Damage(float value) {
        return DawncraftFixesConfig.COMMON.getValues().<ForgeConfigSpec.ConfigValue<Double>>get("dual_greatsword.greatsword_dual_auto.3.damage").get().floatValue();
    }
    ...
    private static float dcfixes$greatswordDualAuto3Damage1(float value) {
        return DawncraftFixesConfig.COMMON.getValues().<ForgeConfigSpec.ConfigValue<Double>>get("dual_greatsword.greatsword_dual_auto.3.damage1").get().floatValue();
    }
    ...
    private static float dcfixes$greatswordDualAuto3AttackSpeed(float value) {
        return DawncraftFixesConfig.COMMON.getValues().<ForgeConfigSpec.ConfigValue<Double>>get("dual_greatsword.greatsword_dual_auto.3.attackSpeed").get().floatValue();
    }
    ...
    private static float dcfixes$greatswordDualAuto4Damage(float value) {
        return DawncraftFixesConfig.COMMON.getValues().<ForgeConfigSpec.ConfigValue<Double>>get("dual_greatsword.greatsword_dual_auto.4.damage").get().floatValue();
    }
    ...
    private static float dcfixes$greatswordDualDashDamage(float value) {
        return DawncraftFixesConfig.COMMON.getValues().<ForgeConfigSpec.ConfigValue<Double>>get("dual_greatsword.greatsword_dual_dash.damage").get().floatValue();
    }
    ...
    private static float dcfixes$greatswordDualDashAttackSpeed(float value) {
        return DawncraftFixesConfig.COMMON.getValues().<ForgeConfigSpec.ConfigValue<Double>>get("dual_greatsword.greatsword_dual_dash.attackSpeed").get().floatValue();
    }
    ...
    private static float dcfixes$greatswordDualAirslashDamage(float value) {
        return DawncraftFixesConfig.COMMON.getValues().<ForgeConfigSpec.ConfigValue<Double>>get("dual_greatsword.greatsword_dual_airslash.damage").get().floatValue();
    }
    ...
    private static float dcfixes$greatswordDualAirslashAttackSpeed(float value) {
        return DawncraftFixesConfig.COMMON.getValues().<ForgeConfigSpec.ConfigValue<Double>>get("dual_greatsword.greatsword_dual_airslash.attackSpeed").get().floatValue();
    }
    ...
    private static float dcfixes$greatswordDualEarthquakeDamage(float value) {
        return DawncraftFixesConfig.COMMON.getValues().<ForgeConfigSpec.ConfigValue<Double>>get("dual_greatsword.greatsword_dual_earthquake.damage").get().floatValue();
    }
    ...
    private static float dcfixes$greatswordDualEarthquakeDamage1(float value) {
        return DawncraftFixesConfig.COMMON.getValues().<ForgeConfigSpec.ConfigValue<Double>>get("dual_greatsword.greatsword_dual_earthquake.damage1").get().floatValue();
    }
    ...
    private static float dcfixes$greatswordDualEarthquakeAttackSpeed(float value) {
        return DawncraftFixesConfig.COMMON.getValues().<ForgeConfigSpec.ConfigValue<Double>>get("dual_greatsword.greatsword_dual_earthquake.attackSpeed").get().floatValue();
    }
}
